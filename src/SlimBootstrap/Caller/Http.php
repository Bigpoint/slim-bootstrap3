<?php
namespace SlimBootstrap\Caller;
...
class Http
{
    ...
    public function get(
        ...
        bool $disableCallResultDebugLog = false,
        int $logLevelForStatusCode404 = Monolog\Logger::WARNING
    ): array {
    ...
    public function post(
        ...
        $this->logger->addDebug(
            'calling POST: ' . $url . ' with parameters '
    ...
    public function put(
        ...
        $this->logger->addDebug(
            'calling PUT: ' . $url . ' with parameters '
            . var_export($parameters, true)
        );
     ...
     * @return string
     */
    private function removeTokenParameter(string $url): string
    {
